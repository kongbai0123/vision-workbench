...
[![Version: 2.18.0](https://img.shields.io/badge/Version-2.18.0-45c6b1.svg)](CHANGELOG.md)
...
- **資料管理**：人工審核可依有無標註分類，支援排除訓練、可還原垃圾桶與永久刪除，並提供無額外確認的圖片層級平衡、依來源分組的正式資料分割、Train-only 資料增強，以及可隨專案備份的固定資料版本。
