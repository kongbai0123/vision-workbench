...
[![Version: 2.17.7](https://img.shields.io/badge/Version-2.17.7-45c6b1.svg)](CHANGELOG.md)
...
- **資料管理**：人工審核、排除訓練、可還原垃圾桶與永久刪除，並提供修訂追蹤、依來源分組的資料分割、Train-only 資料增強，以及可隨專案備份的固定資料版本。
