...
MUTATIONS = [
    ...
    (r'/api/projects/[^/]+/(classes|import-preview|import-confirm|review-trash-list|review-trash|review-restore|review-quality|import|review|independence-review|assign|auto-split|split-preview|split-info|split-apply|merge|validate|export|dataset-versions|training-runs|training-compatibility|review-compatibility|model-exports|predictions|ai|capture|screen|video)', {'POST'}),
    (r'/api/(dialog|open-folder|camera/(start|stop|processing|record/start|record/stop)|cvat/(setup|reboot|reboot/cancel|launch|import))', {'POST'}),
