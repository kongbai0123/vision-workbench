...
MUTATIONS = [
    ...
    (r'/api/projects/[^/]+/(classes|import-preview|import-confirm|review-trash-list|review-trash|review-restore|review-quality|import|review|independence-review|assign|auto-split|split-preview|split-info|split-apply|merge|validate|export|dataset-versions|training-runs|training-compatibility|review-compatibility|model-exports|predictions|model-trials|model-comparisons|ai|capture|screen|video)', {'POST'}),
