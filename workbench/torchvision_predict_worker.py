"""Isolated inference for TorchVision detection and semantic models."""
import argparse
...
from .torchvision_engines import Predictor
...
def main():
    ...
    for asset in request["assets"]:
        with Image.open(asset["image_path"]) as source: rgb = np.asarray(source.convert("RGB"), dtype=np.float32)
